      ...
      <header className="border-b border-border bg-card">
        <div className="container py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Maintenance Strategy & Rules</h1>
              <p className="text-muted-foreground text-sm">Philosophy, standards, and integration guidelines for CMMS readiness</p>
            </div>
          </div>
        </div>
      </header>
