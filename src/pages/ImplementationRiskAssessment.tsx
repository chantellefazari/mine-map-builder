...
const RISKS: { title: string; description: string; level: "Critical" | "High" }[] = [
  { title: "Poor User Adoption and Site Culture", description: "Workforce continues verbal requests and reactive habits. System is deployed but not used as the primary operating tool.", level: "Critical" },
  { title: "Parallel Systems Continue", description: "Excel trackers, whiteboard schedules, and manual PO logs persist alongside the new system, creating conflicting records.", level: "Critical" },
  { title: "Immature Stores and Inventory Control", description: "No controlled stores environment, no receiving process, no cycle counting. Parts availability remains unreliable.", level: "Critical" },
  { title: "Incomplete Parts Catalogue and BOM Linkage", description: "Many assets have no linked spare parts. Min/max levels, lead times, and unit costs are not populated for critical items.", level: "Critical" },
  { title: "Work Management Process Not Consistently Followed", description: "WR to WO to close workflow is built but not embedded. Supervisors bypass approval steps. Completion data is incomplete.", level: "High" },
  { title: "Training and Capability Gaps", description: "No role-specific training delivered. No super users identified. Users will not know how to operate the system under pressure.", level: "High" },
  { title: "Resistance to AI or New System Workflows", description: "Site personnel distrust automated suggestions and structured processes. Preference for familiar manual methods.", level: "High" },
  { title: "Lack of Leadership Enforcement", description: "Management does not consistently enforce system use. Supervisors are not held accountable for team compliance.", level: "Critical" },
  { title: "Premature Rollout Before Readiness", description: "Pressure to show progress leads to go-live before stores, training, and process prerequisites are complete.", level: "High" },
  { title: "Inconsistent PM Execution and Data Quality", description: "PM tasks completed without meaningful detail. Inspection results default to generic entries. History is unusable for analysis.", level: "High" },
];
