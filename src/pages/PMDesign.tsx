...
import { CheckboxLayoutPreview } from "@/components/pm-design/CheckboxLayoutPreview";
...
const PMDesign = () => {
  ...
  const renderPMDocument = () => {
    switch (activeView) {
      case "checkbox-layout-preview":
        return <CheckboxLayoutPreview />;
      case "master":
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  onClick={() => setActiveView("checkbox-layout-preview")}
                  tooltip="Checkbox Layout Preview"
                  className={cn(
                    "w-full justify-start gap-3 px-4 py-3",
                    activeView === "checkbox-layout-preview" && "bg-primary/10 text-primary border-l-2 border-primary"
                  )}
                >
                  <ClipboardCheck className="w-4 h-4" />
                  {!isCollapsed && <span className="font-medium">⚡ Checkbox Layout Review</span>}
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
          </SidebarGroupContent>
