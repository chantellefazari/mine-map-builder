...
const PMDesign = () => {
  ...
  const pmDocumentViewIds: ViewType[] = [
    "master",
    "filter-press-daily-offline",
    "filter-press-daily-online",
    "mill-daily",
    "ro-plant-daily",
    "acid-elution-weekly",
    "air-water-services-weekly",
    "bottom-of-tanks-weekly",
    "diesel-farm-weekly",
    "filter-press-weekly",
    "filter-press-compressor-weekly",
    "filter-press-compressor-offline-weekly",
    "gold-room-weekly",
    "grease-oils-weekly",
    "mill-weekly",
    "potable-water-weekly",
    "reagents-weekly",
    "thickener-weekly",
    "top-of-tanks-weekly",
    "admin-generator-weekly",
    "nobles-natural-sump-generator-weekly",
    "juno-generator-weekly",
    "lab-generator-weekly",
    "portable-generators-weekly",
    "power-station-generator-weekly",
    "generator-daily-gn001",
    "generator-daily-gn002",
    "generator-daily-gn003",
    "generator-daily-gn004",
    "generator-daily-gn005",
    "generator-daily-gn006",
    "generator-daily-gn007",
    "generator-daily-gn008",
    "forklift-weekly",
    "ewp-weekly",
    "crane-weekly",
    "water-truck-weekly",
    ...
    "moxy-daily",
    "moxy-weekly",
    "lighting-tower-daily",
    "service-truck-weekly",
    "skid-steer-weekly",
    "field-mcc-inspections-weekly",
    "filter-press-electrical-weekly",
    "ice-machine-weekly",
    "ph-probe-calibration-weekly",
    "safety-shower-weekly",
    "spare-mill-motor-weekly",
    "visual-zone-checks-weekly",
    "crusher-fuel-farm-generator-electrical-weekly",
    "substation-2-weekly",
    "ac-inspection-4-weekly",
    "ac-inspection-12-weekly",
    "pull-wire-checks-12-weekly",
    "rcd-pushbutton-12-weekly",
    "rcd-injection-24-weekly",
    "rcd-testing-admin",
    "rcd-testing-juno-bore",
    "rcd-testing-andys-dam",
    "rcd-testing-lab",
    "rcd-testing-crusher-fuel-farm",
    "rcd-testing-crusher-workshop",
    "rcd-3m-testing-admin",
    "rcd-3m-testing-juno-bore",
    "rcd-3m-testing-andys-dam",
    "rcd-3m-testing-lab",
    "rcd-3m-testing-crusher-workshop",
    "rcd-3m-testing-crusher-fuel-farm",
    "rcd-pb-injection-cip-tanks",
    "rcd-pb-injection-crib-room",
    "rcd-pb-injection-elution",
    "rcd-pb-injection-filter-press",
    "rcd-pb-injection-first-aid-room",
    "rcd-pb-injection-lab",
    "generator-yearly-test",
    "switchboard-52-weekly",
    "cable-test-sheet",
    "emergency-light-12-weekly",
    "filter-press-motor-inspection",
    "full-test-sheet",
    "motor-inspections-filter-press",
    "motor-inspections-gold-room",
    "motor-inspections-kiln-area",
    "motor-inspections-elution",
    "motor-inspections-milling-area",
    "motor-inspections-pwp",
    "motor-inspections-services",
    "motor-inspections-tanks",
    "motor-inspections-thickener",
    "belt-calibration-bc100-monthly",
    "welders-vrd-test-12-weekly",
  ];
  const isPMDocument = [...pmDocumentViewIds, ...lubeViewIds].includes(activeView);
