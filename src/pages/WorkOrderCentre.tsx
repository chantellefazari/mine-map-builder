...
import { AdvancedPlannerView } from "@/components/work-order-centre/advanced-planner/AdvancedPlannerView";
...
const SECTIONS: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "planner", label: "Maintenance Planner", icon: BarChart3 },
    ],
  },
  {
    label: "Spare Parts",
  ...
  return (
    <div className="flex w-full h-[calc(100vh-49px)]">
      ...
      <div className="flex-1 min-w-0 overflow-auto">
        ...
        {view === "planner" && <AdvancedPlannerView />}
