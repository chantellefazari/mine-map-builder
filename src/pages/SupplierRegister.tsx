      ...
      <header className="border-b border-border bg-card">
        <div className="container py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Supplier Register - Foundation</h1>
              <p className="text-muted-foreground">Single source of truth for supplier information - Manual entry only</p>
            </div>
          </div>
        </div>
      </header>
