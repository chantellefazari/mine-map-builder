...
const LOCKED_STANDARDS: LockedStandard[] = [
  ...
  { area: "Asset Tagging", standard: "TYPE A (Major Asset) and TYPE B (Equipment Position) tag standards with Gravotech LS100 production", reference: "TCMG-STD-TAG-002", owner: "Engineering", status: "Locked" },
  { area: "PM Templates", standard: "92 approved PM templates across 3 disciplines (Mechanical, Electrical, Mobile Equipment)", reference: "PM Master List", owner: "Maintenance", status: "Locked" },
