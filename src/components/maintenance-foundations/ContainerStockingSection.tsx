...
const zones = [
  ...
  },
  {
    ...
    categories: [
      ...
      { cc: "19b", name: "Rigging", items: ["Round slings, flat slings, web slings", "Chain blocks, lever hoists", "Shackles (dee, bow, screw pin)", "Wire rope & wire rope clips", "Turnbuckles, hook & eye sets", "Jack chain, ear-lokt buckles"] },
  ...
  },
  {
    ...
    categories: [
      ...
      { cc: "10b", name: "Structural Steel", items: ["SHS — square hollow sections", "RHS — rectangular hollow sections", "C-channel, channel beam", "Equal angle, flat bar (long)", "Steel plate, star pickets", "Bollards, stay brackets"] },
