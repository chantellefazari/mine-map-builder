...
export const SitePartNumberingSection = () => {
  ...
  const categoryData = [
    ...
    { code: "23", name: "Structural Steel", examples: "SHS, RHS, square & rectangular hollow sections, C-channel, equal angle, flat bar, steel plate, star pickets, bollards", container: "LD" },
    { code: "24", name: "Rigging", examples: "Slings (round, flat, web), chain blocks, lever hoists, shackles (dee, bow), wire rope, turnbuckles, hook and eye sets, jack chain, ear-lokt buckles, garrick equipment", container: "C03-ME" },
    { code: "25", name: "PPE", examples: "Hard hats, safety glasses, face shields, respirators, earmuffs, earplugs, nitrile gloves, riggers gloves, hi-vis vests, safety harnesses, fall arrest lanyards", container: "C05-CS" },
  ];
