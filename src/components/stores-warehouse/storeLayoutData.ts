...
const CONTAINER_40FT_W = YARD_DIMENSIONS.courtyardWidthM * PX_PER_M; // flush between legs
...
export const LAYDOWN_ZONES: LaydownZone[] = [
  {
    id: "LD-B",
    label: "Critical Parts Overflow — Under Dome (Row B)",
    shortLabel: "LD-B",
    type: "dome-row",
    color: "#16a34a",
    ...
    physicalWidthM: 7,
    physicalDepthM: 2.5,
    description: "Dome-sheltered row — critical parts overflow requiring environmental protection",
  },
  {
    id: "LD-A",
    label: "Critical Parts Overflow — Under Dome (Row A)",
    shortLabel: "LD-A",
    type: "dome-row",
    color: "#16a34a",
  ...
  },
  {
    ...
    physicalWidthM: 2,
    physicalDepthM: 5,
    description: "Open yard bay — pumps, submersible pumps, pumpsets, multistage pumps",
  },
  {
    id: "LD-D",
    label: "Matec",
    ...
    physicalWidthM: 2,
    physicalDepthM: 5,
    description: "Open yard bay — Matec equipment, crusher liners, screen panels",
  },
  {
    id: "LD-E",
    label: "Electrical",
    ...
    physicalWidthM: 2,
    physicalDepthM: 5,
    description: "Open yard bay — large electrical assemblies, switchboards, MCC frames, large motors",
  },
  {
    id: "LD-F",
    label: "Mechanical",
    ...
    physicalWidthM: 2,
    physicalDepthM: 5,
    description: "Open yard bay — heavy mechanical assemblies, gearboxes, structural steel, pipe lengths",
  },
];
