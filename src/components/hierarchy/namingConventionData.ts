...
export const equipmentPrefixes = [
  ...
  { prefix: "CDSCN", meaning: "Carbon Dewatering Screen", example: "CDSCN001", category: "Carbon Regen" },
...
export const componentSuffixes = [
  ...
  { suffix: "EXC", meaning: "Exciter (Screen/Vibrator)", example: "TRSCN001-EXC001", category: "Screening" },
