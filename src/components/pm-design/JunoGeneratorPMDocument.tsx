...
export const JunoGeneratorPMDocument = () => {
  ...
  const assetNumber = getAssetNumber("Juno Generator");
  return (
    <div className="bg-background min-h-full">
      <div className="border-2 border-border">
        <PMBannerHeader title="Tenant Creek - Juno Generator" subtitle="Mechanical Running PMs - Weekly Inspection (Fitter)" />
