...
const hazardsList: Hazard[] = [
  ...
  { id: "mechanical", icon: <RotateCw className="w-4 h-4" />, label: "Mechanical" },
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[60%] flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-2xl font-bold tracking-wide text-primary">Spare Mill Motor Inspection</h1>
          ...
          <div className="border-b border-border">
            <div className="px-4 py-3 text-sm leading-relaxed space-y-2">
              <div className="flex items-start gap-3">
                ...
                <span>Ensure space heater power supply is available and accessible.</span>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" />
                <span>Ensure all parts, materials and tooling are available and prepared prior to commencing inspection.</span>
              </div>
            </div>
          </div>
          ...
          <tbody>
            {inspectionTasks.map((task) => (
              <tr key={task.id} className="hover:bg-muted/30">
                <td className="border border-border px-3 py-2 text-center font-medium">{task.id}</td>
