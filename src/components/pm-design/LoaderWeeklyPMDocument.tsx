...
const inspectionData: InspectionSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "13", description: "Replace air filter" },
  ...
  {
    sectionName: "Steering & Articulation Joint",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "50", description: "First-aid kit" },
...
export const LoaderWeeklyPMDocument = () => {
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[60%] flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-2xl font-bold tracking-wide text-primary">Weekly Loader Mechanical Inspection</h1>
            </div>
          </div>
        </div>
