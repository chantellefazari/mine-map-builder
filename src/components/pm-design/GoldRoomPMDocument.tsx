...
const hazardsList: Hazard[] = [
  ...
  { id: "heat", icon: <Flame className="w-4 h-4" />, label: "Heat/Burns" },
  { id: "chemical", icon: <ShieldAlert className="w-4 h-4" />, label: "Chemical" },
];

const inspectionData: EquipmentSection[] = [
  {
    equipmentId: "08-PU-009",
    equipmentName: "Cathode Wash Sludge Pump",
    tasks: [
  ...
  {
    equipmentId: "08-PU-010",
    equipmentName: "Electrowinning Cell Sludge Pump",
    tasks: [
      { task: "Check valves and pipework for air leaks" },
      { task: "Check operation of pump" },
    ]
  ...
  {
    equipmentId: "08-EW-010",
    equipmentName: "Electrowinning Cell",
    tasks: [
      { task: "Check valves and pipework for leaks" },
      { task: "Check for rust build up or penetration" },
      { task: "Check overall tank condition. Look for any damage or rust" },
    ]
  },
  {
    equipmentId: "08-BU-002",
    equipmentName: "Barring Furnace Burner",
    tasks: [
        ...
        <div className="grid grid-cols-2 border-b border-border text-xs">
          <div className="border-r border-border">
            ...
            <div className="grid grid-cols-[120px_1fr] border-b border-border">
              ...
              <div className="px-2 py-1.5">Gold Room</div>
            </div>
          ...
          <div>
            <div className="grid grid-cols-[120px_1fr] border-b border-border">
              ...
              <div className="px-2 py-1.5">Operations</div>
            </div>
            <div className="grid grid-cols-[120px_1fr] border-b border-border">
          ...
          <div className="border-b border-border">
            ...
            <div className="px-4 py-3 text-sm leading-relaxed">
              ...
              <p className="text-muted-foreground">
                To safely carry out operational inspection of electrowinning cells, sludge pumps, and furnace equipment for signs of damage or potential failures that may require maintenance attention.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 grid grid-cols-2 gap-4 text-sm">
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <Checkbox id="followup-yes-gr" />
                  <label htmlFor="followup-yes-gr">Yes</label>
                  <Checkbox id="followup-no-gr" />
                  <label htmlFor="followup-no-gr">No</label>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <Checkbox id="update-yes-gr" />
                  <label htmlFor="update-yes-gr">Yes</label>
                  <Checkbox id="update-no-gr" />
                  <label htmlFor="update-no-gr">No</label>
                </div>
              </div>
