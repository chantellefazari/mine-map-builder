...
const inspectionData: EquipmentSection[] = [
  {
    equipmentId: "06-TK-001, 06-AG-001",
    equipmentName: "Cyanide Monorail",
    tasks: [
  ...
  {
    equipmentId: "06-TK-001, 06-AG-001",
    equipmentName: "Cyanide Mixing Tank and Agitator",
    tasks: [
  ...
  {
    equipmentId: "06-PU-001",
    equipmentName: "Cyanide Solution Transfer Pump",
    tasks: [
  ...
  {
    equipmentId: "06-PU-002",
    equipmentName: "Cyanide Dosing Pump (Duty)",
    tasks: [
      { task: "Check pump condition" },
      { task: "Check pump for heat, noise and vibration" },
      { task: "Check inlet and outlet connection, look for leaks" },
  ...
  {
    equipmentId: "06-PU-003",
    equipmentName: "Cyanide Dosing Pump (Standby)",
    tasks: [
      { task: "Check pump condition" },
      { task: "Check pump for heat, noise and vibration" },
      { task: "Check inlet and outlet connection, look for leaks" },
  ...
  {
    equipmentId: "V084",
    equipmentName: "Back Pressure Valve",
    tasks: [
  ...
  {
    equipmentId: "06-PU-004",
    equipmentName: "Cyanide Area Sump Pump",
    tasks: [
    ...
    <div className="bg-background min-h-full">
      ...
      <div className="border-2 border-border">
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[60%] flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-2xl font-bold tracking-wide text-primary">Tenant Creek Reagents Area</h1>
        ...
        <div className="grid grid-cols-2 border-b border-border text-xs">
          ...
          <div className="border-r border-border">
            ...
            <div className="grid grid-cols-[120px_1fr] border-b border-border">
              ...
              <div className="px-2 py-1.5">Reagents</div>
            </div>
        ...
        <div className="border-b border-border">
          ...
          <div className="border-b border-border">
            ...
            <div className="px-4 py-3 text-sm leading-relaxed">
              <p className="font-medium mb-2">Weekly Running Area Inspection – Reagents Area</p>
        ...
        <div className="border-t border-border">
          ...
          <div className="p-3">
            <Textarea className="min-h-[100px] resize-none" placeholder="Check overall tank condition. Look for any damage or rust." />
          </div>
        </div>
