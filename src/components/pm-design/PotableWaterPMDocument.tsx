        ...
        <div className="absolute inset-0 flex items-center">
          ...
          <div className="flex-1 flex justify-center pr-20">
            <h1 className="text-2xl font-bold text-[#D4AF37] tracking-wide">
              Admin Potable Water Weekly Inspection
            </h1>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 text-xs">
          ...
          <div className="border-r border-black">
            <div className="grid grid-cols-[120px_1fr] border-b border-black">
              ...
              <div className="p-1.5">Admin Potable Water System</div>
            </div>
            <div className="grid grid-cols-[120px_1fr] border-b border-black">
      ...
      <div className="border border-t-0 border-black">
        ...
        <table className="w-full text-xs">
          ...
          <tbody>
            ...
            <tr>
              <td className="border border-black p-1.5">Inspect Potable Water Filter Housings</td>
            ...
            <tr>
              <td className="border border-black p-1.5">Inspect Cartridge Filter</td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5"></td>
            ...
            <tr>
              <td className="border border-black p-1.5">Record Date of Cartridge Filter Install</td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5">Date: _______</td>
            </tr>
            <tr>
              <td className="border border-black p-1.5">Inspect UV Light (Functioning or Not)</td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5"></td>
            ...
            <tr>
              <td className="border border-black p-1.5">Inspect and Record Potable Water Level in Potable Water Tank</td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5">Level: _______</td>
            </tr>
            <tr>
              <td className="border border-black p-1.5">Inspect Pipework/Valving for Damage or Leaks</td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5"></td>
            ...
            <tr>
              <td className="border border-black p-1.5">Inspect Potable Pump</td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5 text-center"><Checkbox className="border-black" /></td>
              <td className="border border-black p-1.5"></td>
