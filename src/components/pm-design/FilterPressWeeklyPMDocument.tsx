...
const inspectionData: EquipmentSection[] = [
  {
    ...
    tasks: [
      ...
      { task: "Check Trough for leaks and Clear of Cake" },
      { task: "Check Plate slide for build up or damage" },
      { task: "Check Hydraulic Tank Level, top up if required" },
      { task: "Check all Hydraulic lines for leaks or damage" },
      { task: "Check Handrails and Walkway mesh" },
  ...
  },
  {
    ...
    tasks: [
      { task: "Check all Plate connection bolts and chains" },
      { task: "Grease Plate wheel assembly located at end of filter top level" },
      { task: "Check all Air actuated Rams, fittings and hoses for leaks and damage" },
      { task: "Check Trough for leaks and Clear of Cake" },
      { task: "Check Plate slide for build up or damage" },
      { task: "Check Hydraulic Tank Level, top up if required" },
  ...
  },
  {
    ...
    tasks: [
      { task: "Check Head End Tail Drum Bearings for Noise or heat", hasTemp: true },
      { task: "Check Tail end Bearings for heat or Noise", hasTemp: true },
      { task: "Grease Head and Tail end Bearing Assembly" },
      { task: "Check Guarding" },
      { task: "Check all Rollers. Trough, Return and Guide" },
      { task: "Check all scrapers, V-plough position & condition" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { task: "Bearing assembly temperature, Serviceable range: < 80°C", hasTemp: true },
      { task: "Gland water pressure Serviceable range: ~400 kPa", hasPressure: true },
          ...
          <div className="border-b border-border">
            ...
            <div className="px-4 py-3 text-sm leading-relaxed">
              ...
              <p className="text-muted-foreground">
                To safely carry out mechanical inspection of filter presses, conveyors, feed pumps, and air systems for signs of damage or potential failures that may require maintenance attention.
              </p>
            </div>
          </div>
                    ...
                    {section.tasks.map((task, taskIdx) => (
                      <tr key={`task-${sectionIdx}-${taskIdx}`} className="hover:bg-muted/50">
                        ...
                        <td className="border border-border px-2 py-2">
                          {task.hasTemp && (
                            <span className="text-muted-foreground">Temp: _______ °C</span>
                          )}
                          {task.hasPressure && (
                            <span className="text-muted-foreground">Pressure: _______ kPa</span>
                          )}
                        </td>
                      </tr>
                    ))}
          ...
          <div className="p-4 grid grid-cols-2 gap-4 text-sm">
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <Checkbox id="followup-yes-fpw" />
                  <label htmlFor="followup-yes-fpw">Yes</label>
                  <Checkbox id="followup-no-fpw" />
                  <label htmlFor="followup-no-fpw">No</label>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <Checkbox id="update-yes-fpw" />
                  <label htmlFor="update-yes-fpw">Yes</label>
                  <Checkbox id="update-no-fpw" />
                  <label htmlFor="update-no-fpw">No</label>
                </div>
              </div>
