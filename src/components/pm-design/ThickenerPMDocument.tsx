...
const inspectionData: EquipmentSection[] = [
  {
    equipmentId: "12-TM-001",
    equipmentName: "Thickener Tank",
    tasks: [
  ...
  {
    equipmentId: "12-HP-201",
    equipmentName: "Hydraulic Power Pack",
    tasks: [
  ...
  {
    equipmentId: "12-TM-001",
    equipmentName: "Control Panel & Instruments (PN 205)",
    tasks: [
  ...
  {
    equipmentId: "12-HP-001",
    equipmentName: "Flocculant Powder Hopper",
    tasks: [
  ...
  {
    equipmentId: "12-TK-001",
    equipmentName: "Flocculant Mixing Tank",
    tasks: [
  ...
  {
    equipmentId: "12-PU-200A",
    equipmentName: "Underflow Pump A",
    tasks: [
  ...
  {
    equipmentId: "12-PU-200B",
    equipmentName: "Underflow Pump B",
    tasks: [
      { task: "Running or Standby (skip if pump on standby)", hasInput: true, inputLabel: "Running □ Standby □" },
      { task: "Bearing assembly temperature (Serviceable range: < 80°C)", hasInput: true, inputLabel: "Temp: _______ °C" },
      { task: "Gland water pressure (Serviceable range: ~400 kPa)", hasInput: true, inputLabel: "Pressure: _______ kPa" },
  ...
  {
    equipmentId: "12-PU-210",
    equipmentName: "Thickener Sump Pump",
    tasks: [
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[60%] flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-2xl font-bold tracking-wide text-primary">Tenant Creek Leaching Area - Thickener</h1>
        ...
        <div className="grid grid-cols-2 border-b border-border text-xs">
          ...
          <div className="border-r border-border">
            ...
            <div className="grid grid-cols-[120px_1fr] border-b border-border">
              ...
              <div className="px-2 py-1.5">Thickener</div>
            </div>
        ...
        <div className="border-b border-border">
          ...
          <div className="border-b border-border">
            ...
            <div className="px-4 py-3 text-sm leading-relaxed">
              <p className="font-medium mb-2">Weekly Running Area Inspection – Thickener</p>
