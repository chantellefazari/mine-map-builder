  ...
  return (
    <div className="bg-background min-h-full">
      <div className="border-2 border-border">
        ...
        {/* SafeTac VRD Reference Section */}
        <div className="border-t-2 border-foreground">
          <div className="bg-foreground text-background text-center text-sm font-bold py-1.5 uppercase tracking-wide">
          ...
          <div className="px-4 py-3 text-xs space-y-3 leading-relaxed">
            ...
            <p className="italic">Note: To test the switching time a recording storage oscilloscope should be used.</p>
