      ...
      <div className="border-2 border-border">
        ...
        <div className="grid grid-cols-2 border-b border-border text-xs">
          ...
          <div>
            ...
            <div className="grid grid-cols-[120px_1fr] border-b border-border"><div className="bg-muted px-2 py-1.5 font-semibold border-r border-border">PM Type:</div><div className="px-2 py-1.5">Service</div></div>
