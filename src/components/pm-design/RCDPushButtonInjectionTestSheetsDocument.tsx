...
const rcdLocations: RCDLocation[] = [
  ...
  {
    id: "first-aid-room",
    name: "First Aid Room / SB-002G",
    area: "FIRST AID ROOM",
    asset: "ADMIN OFFICES",
    assetDescription: "SB-002G",
    circuits: [
      { description: "POWER", rating: "20A" },
      { description: "POWER", rating: "20A" },
      { description: "POWER", rating: "20A" },
      { description: "AC", rating: "20A" },
      { description: "LIGHTS", rating: "6A" },
      { description: "POWER", rating: "20A" },
      ...Array.from({ length: 14 }, () => ({ description: "", rating: "" })),
    ],
  },
  {
    ...
    area: "LAB",
    asset: "SB-105A",
    assetDescription: "LAB MAIN DB",
    circuits: [
      { description: "", rating: "" },
      { description: "LIGHTS", rating: "10A" },
      { description: "", rating: "" },
      { description: "FAN", rating: "10A" },
      { description: "", rating: "" },
      { description: "POWER", rating: "16A" },
      { description: "", rating: "" },
      { description: "POWER", rating: "16A" },
      ...
      { description: "", rating: "" },
      { description: "", rating: "" },
      { description: "AC1", rating: "20A" },
      { description: "", rating: "" },
      { description: "AC2", rating: "20A" },
      { description: "", rating: "" },
      { description: "AC 3", rating: "20A" },
      { description: "VSD FAN", rating: "10A" },
      { description: "15A OVEN", rating: "20A" },
      { description: "FUME CABINET", rating: "16A" },
    ],
  },
];
