...
const hazardsList: Hazard[] = [
  ...
  { id: "fire", icon: <Flame className="w-4 h-4" />, label: "Fire/Flammable" },
  { id: "spill", icon: <Droplets className="w-4 h-4" />, label: "Spill Hazard" },
  { id: "environmental", icon: <AlertOctagon className="w-4 h-4" />, label: "Environmental" },
];

const inspectionData: EquipmentSection[] = [
  {
    equipmentId: "CIP Plant Fuel Tank",
    equipmentName: "CIP Plant Fuel Tank",
    tasks: [
      { task: "Check Condition of hoses" },
      { task: "Check condition of fuel nozzles" },
      { task: "Check pumps" },
      { task: "Check all connections" },
      { task: "Check for Leaks" },
      { task: "Check Fire extinguisher" },
      { task: "Check/replace spill kit" },
    ]
  },
  {
    equipmentId: "Crusher Fuel Tank",
    equipmentName: "Crusher Fuel Tank",
    tasks: [
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[60%] flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-2xl font-bold tracking-wide text-primary">Tenant Creek - Diesel Farm Check</h1>
        ...
        <div className="grid grid-cols-2 border-b border-border text-xs">
          <div className="border-r border-border">
            ...
            <div className="grid grid-cols-[120px_1fr] border-b border-border">
              ...
              <div className="px-2 py-1.5">Diesel Farm</div>
            </div>
          ...
          <div className="border-b border-border">
            ...
            <div className="px-4 py-3 text-sm leading-relaxed">
              ...
              <p className="text-muted-foreground">
                To safely carry out mechanical inspection of fuel storage and dispensing equipment for signs of damage, leaks, or potential failures that may require maintenance attention.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 grid grid-cols-2 gap-4 text-sm">
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <Checkbox id="followup-yes-df" />
                  <label htmlFor="followup-yes-df">Yes</label>
                  <Checkbox id="followup-no-df" />
                  <label htmlFor="followup-no-df">No</label>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <Checkbox id="update-yes-df" />
                  <label htmlFor="update-yes-df">Yes</label>
                  <Checkbox id="update-no-df" />
                  <label htmlFor="update-no-df">No</label>
                </div>
              </div>
