...
const inspectionData: EquipmentSection[] = [
  { equipmentId: "CIP Plant Fuel Tank", equipmentName: "CIP Plant Fuel Tank", tasks: [
  ...
  { equipmentId: "Crusher Fuel Tank", equipmentName: "Crusher Fuel Tank", tasks: [
      ...
      <div className="border-2 border-border">
        ...
        <div className="grid grid-cols-2 border-b border-border text-xs">
          <div className="border-r border-border">
            ...
            <div className="grid grid-cols-[120px_1fr] border-b border-border"><div className="bg-muted px-2 py-1.5 font-semibold border-r border-border">Plant Area Desc.:</div><div className="px-2 py-1.5">Diesel Farm</div></div>
        ...
        <div className="border-b border-border">
          ...
          <div className="p-4 grid grid-cols-2 gap-4 text-sm">
            <div className="space-y-3">
              <div className="flex items-center gap-4"><span className="text-muted-foreground">Follow up work required:</span><div className="flex gap-2"><Checkbox id="followup-yes-df" /><label htmlFor="followup-yes-df">Yes</label><Checkbox id="followup-no-df" /><label htmlFor="followup-no-df">No</label></div></div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4"><span className="text-muted-foreground">Document update required:</span><div className="flex gap-2"><Checkbox id="update-yes-df" /><label htmlFor="update-yes-df">Yes</label><Checkbox id="update-no-df" /><label htmlFor="update-no-df">No</label></div></div>
