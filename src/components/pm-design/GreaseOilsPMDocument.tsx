        ...
        <div className="grid grid-cols-2 border-b border-border text-xs">
          <div className="border-r border-border">
            ...
            <div className="grid grid-cols-[120px_1fr] border-b border-border">
              ...
              <div className="px-2 py-1.5">Store</div>
            </div>
          ...
          <div className="border-b border-border">
            ...
            <div className="px-4 py-3 text-sm leading-relaxed">
              ...
              <p className="text-muted-foreground">
                To check lubricant stock levels against recommended quantities and ensure adequate supplies are maintained for maintenance operations.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 grid grid-cols-2 gap-4 text-sm">
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <Checkbox id="followup-yes-go" />
                  <label htmlFor="followup-yes-go">Yes</label>
                  <Checkbox id="followup-no-go" />
                  <label htmlFor="followup-no-go">No</label>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <Checkbox id="update-yes-go" />
                  <label htmlFor="update-yes-go">Yes</label>
                  <Checkbox id="update-no-go" />
                  <label htmlFor="update-no-go">No</label>
                </div>
              </div>
