...
const templateRegistry: PMTemplateDefinition[] = [
  ...
  { pmName: "Andy Dam Generator Weekly Inspection", discipline: "Mechanical", frequency: "1 Week", equipmentType: "Andy Dam Generator", bannerTitle: "Tenant Creek - Andy Dam Generator", bannerSubtitle: "Mechanical Running PMs - Weekly Inspection (Fitter)", projectSite: "Tenant Creek", plantArea: "Andy Dam Generator", pmGroup: "Mechanical", pmType: "Inspection (Fitter)", footerText: "Tennant Creek Mining Operations – Andy Dam Generator Weekly Inspection Form", hasMobileEquipmentHeader: true, templateType: "DynamicInspectionTable", customLayoutNotes: "" },
